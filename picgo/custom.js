    ...
    target.find('input , textarea , select').each(function(){
        if($(this).hasClass('require')){
            if($(this).val().trim() == ''){
                ...
                targetResp.php('You missed out some fields.');
                $(this).addClass('error');
                return false;
            }else{
        ...
        if($(this).val().trim() != ''){
            ...
            if(typeof valid != 'undefined'){
                if(!eval(valid).test($(this).val().trim())){
                    ...
                    $(this).focus();
                    check = 1;
                    targetResp.php($(this).attr('data-error'));
                    return false;
                }else{
                    $(this).removeClass('error');
                }
       ...
       var formDetail = new FormData(targetForm[0]);
        ...
        $.ajax({
            ...
            if(resp == 1){
                ...
                errroTarget.php('<p style="color:green;">Mail has been sent successfully.</p>');
            }else{
                errroTarget.php('<p style="color:red;">Something went wrong please try again latter.</p>');
            }
        });
    }
});
